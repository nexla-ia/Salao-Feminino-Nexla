...
import 'd_dia_hora_salao_nexla_model.dart';
export 'd_dia_hora_salao_nexla_model.dart';
...
class DDiaHoraSalaoNexlaWidget extends StatefulWidget {
  const DDiaHoraSalaoNexlaWidget({super.key});

  static String routeName = 'D-DiaHoraSalaoNexla';
  static String routePath = '/dDiaHoraSalaoNexla';

  @override
  State<DDiaHoraSalaoNexlaWidget> createState() =>
      _DDiaHoraSalaoNexlaWidgetState();
}

class _DDiaHoraSalaoNexlaWidgetState extends State<DDiaHoraSalaoNexlaWidget> {
  late DDiaHoraSalaoNexlaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DDiaHoraSalaoNexlaModel());
  }
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                        DConfirmarSalaoNexlaWidget.routeName);
                                  },
                                  text: 'PRÓXIMA ETAPA',
                                  options: FFButtonOptions(
                                    height: 48.0,
