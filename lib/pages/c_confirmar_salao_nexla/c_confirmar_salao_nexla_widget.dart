...
import 'c_confirmar_salao_nexla_model.dart';
export 'c_confirmar_salao_nexla_model.dart';
...
class CConfirmarSalaoNexlaWidget extends StatefulWidget {
  const CConfirmarSalaoNexlaWidget({super.key});

  static String routeName = 'C-ConfirmarSalaoNexla';
  static String routePath = '/cConfirmarSalaoNexla';

  @override
  State<CConfirmarSalaoNexlaWidget> createState() =>
      _CConfirmarSalaoNexlaWidgetState();
}

class _CConfirmarSalaoNexlaWidgetState
    extends State<CConfirmarSalaoNexlaWidget> {
  late CConfirmarSalaoNexlaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CConfirmarSalaoNexlaModel());
  }
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed(
                                          CServicoSalaoNexlaWidget.routeName);
                                    },
