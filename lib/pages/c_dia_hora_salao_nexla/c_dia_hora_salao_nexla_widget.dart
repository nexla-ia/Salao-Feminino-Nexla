...
import 'c_dia_hora_salao_nexla_model.dart';
export 'c_dia_hora_salao_nexla_model.dart';
...
class CDiaHoraSalaoNexlaWidget extends StatefulWidget {
  const CDiaHoraSalaoNexlaWidget({super.key});

  static String routeName = 'C-DiaHoraSalaoNexla';
  static String routePath = '/cDiaHoraSalaoNexla';

  @override
  State<CDiaHoraSalaoNexlaWidget> createState() =>
      _CDiaHoraSalaoNexlaWidgetState();
}

class _CDiaHoraSalaoNexlaWidgetState extends State<CDiaHoraSalaoNexlaWidget> {
  late CDiaHoraSalaoNexlaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CDiaHoraSalaoNexlaModel());
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Etapa 3 de 4: Escolha Hora e Dia',
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                        CConfirmarSalaoNexlaWidget.routeName);
                                  },
                                  text: 'PRÓXIMA ETAPA',
                                  options: FFButtonOptions(
                                    height: 48.0,
