...
import 'd_servico_salao_nexla_model.dart';
export 'd_servico_salao_nexla_model.dart';
...
class DServicoSalaoNexlaWidget extends StatefulWidget {
  const DServicoSalaoNexlaWidget({super.key});

  static String routeName = 'D-ServicoSalaoNexla';
  static String routePath = '/dServicoSalaoNexla';

  @override
  State<DServicoSalaoNexlaWidget> createState() =>
      _DServicoSalaoNexlaWidgetState();
}

class _DServicoSalaoNexlaWidgetState extends State<DServicoSalaoNexlaWidget> {
  late DServicoSalaoNexlaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DServicoSalaoNexlaModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      final _colorPickedColor = await showFFColorPicker(
        context,
        currentColor:
            _model.colorPicked ?? FlutterFlowTheme.of(context).primary,
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Corte estilizado conforme seu gosto',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Secagem e modelagem profissional',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                                font: GoogleFonts.inter(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Limpeza, corte, esmaltação e hidratação',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                                font: GoogleFonts.inter(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Tratamento nutritivo para cabelos secos',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                                font: GoogleFonts.inter(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Modelagem e correção com pinça',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                                font: GoogleFonts.inter(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Cuidado com esfoliação e massagem',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                                font: GoogleFonts.inter(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Tonalização e reflexos profissionais',
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                                font: GoogleFonts.inter(
