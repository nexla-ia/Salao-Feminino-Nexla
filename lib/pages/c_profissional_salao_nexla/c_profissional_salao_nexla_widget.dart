...
import 'c_profissional_salao_nexla_model.dart';
export 'c_profissional_salao_nexla_model.dart';
...
class CProfissionalSalaoNexlaWidget extends StatefulWidget {
  const CProfissionalSalaoNexlaWidget({super.key});

  static String routeName = 'C-ProfissionalSalaoNexla';
  static String routePath = '/cProfissionalSalaoNexla';

  @override
  State<CProfissionalSalaoNexlaWidget> createState() =>
      _CProfissionalSalaoNexlaWidgetState();
}

class _CProfissionalSalaoNexlaWidgetState
    extends State<CProfissionalSalaoNexlaWidget> {
  late CProfissionalSalaoNexlaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CProfissionalSalaoNexlaModel());
  }
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                        CDiaHoraSalaoNexlaWidget.routeName);
                                  },
                                  text: 'PRÓXIMA ETAPA',
                                  options: FFButtonOptions(
                                    height: 48.0,
