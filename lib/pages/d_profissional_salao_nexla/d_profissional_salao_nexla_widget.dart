...
import 'd_profissional_salao_nexla_model.dart';
export 'd_profissional_salao_nexla_model.dart';
...
class DProfissionalSalaoNexlaWidget extends StatefulWidget {
  const DProfissionalSalaoNexlaWidget({super.key});

  static String routeName = 'D-ProfissionalSalaoNexla';
  static String routePath = '/dProfissionalSalaoNexla';

  @override
  State<DProfissionalSalaoNexlaWidget> createState() =>
      _DProfissionalSalaoNexlaWidgetState();
}

class _DProfissionalSalaoNexlaWidgetState
    extends State<DProfissionalSalaoNexlaWidget> {
  late DProfissionalSalaoNexlaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DProfissionalSalaoNexlaModel());
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Etapa 2 de 4: Escolha do Profissional',
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                        DDiaHoraSalaoNexlaWidget.routeName);
                                  },
                                  text: 'PRÓXIMA ETAPA',
                                  options: FFButtonOptions(
                                    height: 48.0,
